...
class ClassificationResult {
  ...
  static ClassificationResult decode(Object result) {
    ...
    return ClassificationResult(
      languageTag: result[0]! as String,
  ...
  bool operator ==(Object other) {
    if (other is! ClassificationResult || other.runtimeType != runtimeType) {
      return false;
    }
    if (identical(this, other)) {
      return true;
    }
    return _deepEquals(languageTag, other.languageTag) && _deepEquals(confidence, other.confidence);
  }
...
class FastTextClassifierApi {
  /// Constructor for [FastTextClassifierApi]. The [binaryMessenger] named argument is
  /// available for dependency injection. If it is left null, the default
  /// BinaryMessenger will be used which routes to the host platform.
  FastTextClassifierApi({BinaryMessenger? binaryMessenger, String messageChannelSuffix = ''})
  ...
  Future<ClassificationResult> classifyText(String text) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.soniq.FastTextClassifierApi.classifyText$pigeonVar_messageChannelSuffix';
    ...
    ;
    return pigeonVar_replyValue! as ClassificationResult;
  }
}
